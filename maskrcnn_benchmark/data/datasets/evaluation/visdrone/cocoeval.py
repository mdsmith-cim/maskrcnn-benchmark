__author__ = 'tsungyi'
# Modified from COCO eval code https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocotools/coco.py
...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[1] = _summarize(1, iouThr=.5, maxDets=self.params.maxDets[3])
            stats[2] = _summarize(1, iouThr=.75, maxDets=self.params.maxDets[3])
            ...
            stats[6] = _summarize(0, maxDets=self.params.maxDets[3])
